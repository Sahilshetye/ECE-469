...
#define MAXPI           2000    /* numebr of primary inputs */
#define MAXPO           2050    /* number of primary outputs */
#define MAXFAULT        40000   /* number of faults */
#define MAXFIN          15      /* number of fanin lines */
#define	MAXFOUT		15	/* maximum number of fanout lines */

#define MAXSTRING       200     /* maximum size of a string */
...
/* For ATALANTA only */
#define	MAXBUF		500	/* number of buffers for backtrace */
#define	MAXOBJ		1000
#define	MAXTREE		400
